 ...
 * 请你来实现一个 atoi 函数，使其能将字符串转换成整数。
 ...
      因此返回 INT_MIN (−231) 。
 */
public class N8StringToIntegerAtoi {
    ...
    public int myAtoi(String str) {
        ...
        int len = str.length();
        int start = 0;
        while (start < len && chars[start] == ' ') start++; // 跳过开头的空格
        if (start == len) return 0; // 全部都是空格
        ...
        while (start < len && Character.isDigit(chars[start])) {
            ...
            // 但是 res *10 和 + digit 都有可能越界，所有都移动到右边去就可以了。
...
//        String s = "  +42sff";
//        String s = "  +ad42sff";
//        String s = "  -4254353453454544534sff";
//        String s = "  4254353453454544534sff";
        String s = "+";
